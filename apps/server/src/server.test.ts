    ...
    const appLayer = HttpRouter.serve(makeRoutesLayer, {
      ...
      Layer.provide(
        Layer.mock(SnippetRepository)({
          ...
          upsertByExactText: () =>
            Effect.die(new Error("SnippetRepository.upsertByExactText not implemented in test")),
          deleteById: () =>
            Effect.die(new Error("SnippetRepository.deleteById not implemented in test")),
          streamChanges: Stream.empty,
      ...
      Layer.provide(
        Layer.mock(CodexImport)({
          ...
          peekSession: () =>
            Effect.die(new Error("CodexImport.peekSession not implemented in test")),
          importSessions: () =>
            Effect.die(new Error("CodexImport.importSessions not implemented in test")),
