...
function sessionKindLabel(kind: CodexImportSessionSummary["kind"]): string {
  if (kind === "subagent-child") {
    return "Subagent";
  }
  ...
  return (
    ...
    >
      <DialogPopup className="max-w-6xl" bottomStickOnMobile={false}>
        ...
        >
          <div className="grid shrink-0 gap-3 md:grid-cols-[minmax(0,1fr)_12rem_auto]">
            <Input
                  ...
                  {!highlightedSessionId ? (
                    ...
                    <>
                      <div className="space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                          <h3 className="text-sm font-medium">{previewQuery.data.title}</h3>
                          <Badge size="sm" variant="outline">
                            {sessionKindLabel(previewQuery.data.kind)}
                          </Badge>
