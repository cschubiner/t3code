...
function resultKindLabel(kind: "title" | "message-user" | "message-assistant" | "proposed-plan") {
  switch (kind) {
    case "title":
      return "Title";
    case "message-user":
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPopup className="max-w-6xl" bottomStickOnMobile={false}>
        <DialogHeader>
          ...
          <DialogDescription>
            Search thread titles, user messages, assistant replies, and proposed plans across the
            current workspace.
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="divide-y">
                {deferredQuery.trim().length === 0 ? (
                  <div className="p-4 text-sm text-muted-foreground">
                    Start typing to search across all threads.
                  </div>
