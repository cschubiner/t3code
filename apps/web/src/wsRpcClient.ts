...
export interface WsRpcClient {
  ...
  readonly skills: {
    readonly search: (input: SkillSearchInput) => Promise<SkillSearchResult>;
  };
  readonly snippets: {
    readonly list: () => Promise<SnippetListResult>;
    readonly create: (input: SnippetCreateInput) => Promise<SnippetCreateResult>;
    readonly delete: (input: SnippetDeleteInput) => Promise<void>;
    readonly onUpdated: (listener: (event: SnippetLibraryUpdatedPayload) => void) => () => void;
  };
  readonly shell: {
  ...
  readonly codexImport: {
    ...
    ) => Promise<CodexImportPeekSessionResult>;
