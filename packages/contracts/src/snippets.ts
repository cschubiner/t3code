...
import { IsoDateTime, SnippetId, TrimmedNonEmptyString } from "./baseSchemas.ts";
...
export class SnippetLibraryError extends Schema.TaggedErrorClass<SnippetLibraryError>()(
  "SnippetLibraryError",
  {
